...
const fields = [
  ...
  },
  {
    ...
    type: "text",
    placeholder: "App idea, collaboration, consulting…",
  },
  {
    id: "message",
    label: "Anything else?",
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseLeave={(e) =>
            gsap.to(e.currentTarget, { opacity: 0.55, duration: 0.2 })
          }
        >
          Close
        ...
        {!submitted ? (
          ...
          <div>
            ...
            <button
              className="bk-success-el link-arrow"
              onClick={close}
              style={{
                fontSize: 14,
                color: "var(--ink)",
